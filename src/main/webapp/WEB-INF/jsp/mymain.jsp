                                            ...
                                            <tr class="firstTr" v-for="site in obj">
                                                ...
                                                <td>
                                                        ...
                                                        <c:if test="${orders.status.equals('已预订')}">
                                                            <a href="#" onclick="updateOrder(${orders.orderId})" style="color:red">还车</a>
                                                        </c:if>
                                                        <c:if test="${orders.status.equals('已归还')}">
                                                            <a href="#" onclick="deleteByOrderId(${orders.orderId})" style="color:red">删除</a>
                                                        </c:if>
                                                </td>
                                            </tr>
                                        </c:forEach>
...
<script type="text/javascript">
    ...
    function deleteByOrderId(orderId) {
        ...
        $("#app").load(baseUrl + "deleteOrder", params);
    }
    ...
    function updateOrder(orderId) {
        ...
        $("#app").load(baseUrl + "updateOrderStatus", params);
