...
<div class="cBody">
    ...
    <!-- 三级省市 插件 -->
    <script src="${pageContext.request.contextPath}/resources/framework/area.js"></script>
    <script src="${pageContext.request.contextPath}/resources/framework/province.js"></script>
    <script>
        //默认城市为：宁夏 - 银川
        var defaults = {
            s1: 'provid',
